...
<head>
    ...
    {{-- SEO --}}
    <meta name="description" content="Verify Your Email Address to your Abhishek Portfolio account to manage your profile, projects, and settings securely.">
    <meta name="keywords" content="Abhishek Portfolio Verify Your Email Address, User Verify Your Email Address, Secure Verify Your Email Address, Abhishek Account Access, Portfolio Verify Your Email Address">
    ...
    <title>{{ config('app.name', 'Abhishek Portfolio') }} | Verify Your Email Address </title>
                        ...
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                ...
                                <td style="text-align:center;">
                                    {{-- <img width="200" height="120" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/backend/assets/img/logo/damian-logo.png'))) }}" title="Damian Corporate" alt="logo"> --}}
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:16px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">
                                &copy;
                                <strong>
                                    <a href="{{ route('frontend.home') }}" title="Abhishek Jha" target="_blank">
                                        || Abhishek Jha ||
                                    </a>
                                </strong>
