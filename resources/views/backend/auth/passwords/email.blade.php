...
<head>
    ...
    {{-- SEO --}}
    <meta name="description" content="Reset Password Link to your Abhishek Portfolio account to manage your profile, projects, and settings securely.">
    <meta name="keywords" content="Abhishek Portfolio Reset Password Link, User Reset Password Link, Secure Reset Password Link, Abhishek Account Access, Portfolio Reset Password Link">
    ...
    <!-- Title -->
    <title>{{ config('app.name', 'Abhishek Portfolio') }} | Reset Password Link</title>
