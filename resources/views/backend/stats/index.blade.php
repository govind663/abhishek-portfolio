...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a class="btn btn-primary" href="{{ route('stats.create') }}">
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All Stats Records</h4>
            </div>

            <div class="pb-20">
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3" data-title="Stats List">
                    <thead>
                        <tr>
                            <th>Sr. No.</th>
                            <th>Title</th>
