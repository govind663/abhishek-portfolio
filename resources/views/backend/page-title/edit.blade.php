...
<div class="pd-ltr-20 xs-pd-10-10">
    <div class="min-height-200px">
        ...
        {{-- Form --}}
        <form action="{{ route('page-titles.update', $pageTitle->id) }}" method="POST" 
            ...
            <div class="card-box pd-20 mb-30">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="page_name" id="page_name"
                                ...
                                value="{{ old('page_name', $pageTitle->page_name) }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="active" {{ old('status', $pageTitle->status)=='active'?'selected':'' }}>Active</option>
                                <option value="inactive" {{ old('status', $pageTitle->status)=='inactive'?'selected':'' }}>Inactive</option>
                            </select>
                            @error('status')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="text-right mt-4">
                    ...
                    <button type="submit" class="btn btn-success">Update Page Title</button>
                </div>
