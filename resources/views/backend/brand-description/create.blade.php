...
<div class="pd-ltr-20 xs-pd-10-10">
    <div class="min-height-200px">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="title">
                        <h4>Create Brand Description</h4>
                    </div>
        ...
        {{-- FORM --}}
        <form action="{{ route('brand-description.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="file" name="logo" id="logo" class="form-control @error('logo') is-invalid @enderror" onchange="previewImage('logo','logo-preview')" accept=".jpg,.jpeg,.png,.webp">
