...
<div class="pd-ltr-20 xs-pd-10-10">
    <div class="min-height-200px">
        ...
        {{-- Form  --}}
        <form action="{{ route('seo-settings.update', $seo->id) }}" method="POST" class="form-horizontal" id="seo-form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" accept-charset="UTF-8" data-toggle="validator') }}">
            @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="page_name"
                                ...
                                value="{{ old('page_name', $seo->page_name) }}"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description"
                                ...
                                placeholder="Write a compelling meta description (150-160 characters recommended)...">{{ old('description', $seo->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            {{-- ✅ Image Preview --}}
                            <div id="og-preview" style="margin-top:10px;">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="og_description"
                                ...
                                placeholder="Short description for social media preview...">{{ old('og_description', $seo->og_description) }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            {{-- Conditional Preview --}}
                            <div id="twitter-preview" style="margin-top:10px;">
                                <img src="{{ $seo->twitter_image }}" 
                                    style="width:100px; height:100px; object-fit:cover; border-radius:5px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="twitter_description" id="twitter_description"
                                ...
                                placeholder="Short engaging description for Twitter...">{{ old('twitter_description', $seo->twitter_description) }}</textarea>
