...
class UpdateSeoSettingRequest extends FormRequest
{
    ...
    {
        return [
            'page_name' => 'required|string|max:100' . $this->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'page_name.string' => __('Page name must be a string'),
            'page_name.max' => __('Page name may not be greater than 100 characters'),
